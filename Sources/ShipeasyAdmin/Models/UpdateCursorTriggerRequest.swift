//
// UpdateCursorTriggerRequest.swift
//
...
public struct UpdateCursorTriggerRequest: Codable, JSONEncodable {
    ...
    public init(provider: Provider, name: String? = nil, config: CursorTriggerConfig, apiKey: String? = nil, opsKey: String? = nil) {
